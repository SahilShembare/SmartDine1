...
export default function Sidebar({ mode = 'admin' }) {
  ...
  const adminLinks = [
    ...
    { to: '/kitchen', label: 'Kitchen Monitor (View Only)', icon: ChefHat },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="p-3.5 rounded-2xl bg-slate-800/50 border border-slate-700/60 flex items-center gap-3">
          ...
          <div className="overflow-hidden">
            ...
            <span className="inline-block text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
